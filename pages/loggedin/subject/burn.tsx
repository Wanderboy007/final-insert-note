    ...
    <>
      <Navbar fluid={true}>
        ...
        <Navbar.Collapse>
          ...
          <Navbar.Link href="../home">Subjects</Navbar.Link>
          <Navbar.Link href="#">Test</Navbar.Link>
        </Navbar.Collapse>
      </Navbar>
      <div className="m-20 flex flex-col items-center">
        <h2 className="text-4xl dark:text-white">INTRODUCTION</h2>
        ...
        <h2 className="text-4xl dark:text-white">Burns</h2>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">TYPES OF BURNS INJURY :</h3>
        ...
        <h2 className="text-4xl dark:text-white">CLASSIFICATION OF BURNS </h2>
        ...
        <h3 className="text-4xl dark:text-white">• Fourth-degree burns:</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">1) Minor Burns :</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">2) Moderate burns:</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">3) Severe Burns :</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <p className="my-4 text-lg text-gray-500">
          ...
          of how much body surface area is burned. For example, if a
          patient&apos;s entire back (18%) and entire left leg (18%) are burned,
          about 36% of the patient&apos;s BSA is affected. The BSAs assigned to
          each body part refer to the entire body part. So, for example, if half
          of a patient&apos;s left leg were burned, it would be assigned a BSA
          value of 9% (half the total surface area of the leg). Thus, if a
          patient&apos;s entire back (18%), but only half of their left leg (9%)
          was burned, the amount of BSA affected would be 27%.
        </p>
        <div>
        ...
        <p className="my-4 text-lg text-gray-500">
          The &quot;rule of palm&quot; is another way to estimate the size of a
          burn. The palm of the person who is burned (not fingers or wrist area)
          is about 1% of the body. Use the person&apos;s palm to measure the
          body surface area burned. It can be hard to estimate the size of a
          burn
        </p>
        <div>
        ...
        <h2 className="text-4xl dark:text-white">NURSING ASSESSMENT:-</h2>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h2 className="text-4xl dark:text-white">EMERGENT PHASE :</h2>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">EMERGENT PHASE :</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">Fluid management: </h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">1) Parkland formula: </h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">2) Consensus formula :</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">3. Evans formula</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">4) Brooke army formula :</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">DRUGS </h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h2 className="text-4xl dark:text-white">SURGERY: - </h2>
        <h3 className="text-4xl dark:text-white">Escharotomy</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">Fasciotomy:</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h1 className="text-4xl dark:text-white">NURSING MANAGEMENT</h1>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h2 className="text-4xl dark:text-white">ACUTE PHASE</h2>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">1) WOUND CARE :</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <p className="my-4 text-lg text-gray-500">
          ...
          <br />
          • If patient&apos;s condition is not stable, then delayed debridement
          is done after 15-20 days, after patient becomes stable, followed by
          skin grafting. <br />
        ...
        <h3 className="text-4xl dark:text-white">3) PAIN MANAGEMENT</h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h3 className="text-4xl dark:text-white">5) NUTRITIONAL THERAPY </h3>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h2 className="text-4xl dark:text-white">REHABILITATION PHASE :</h2>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h2 className="text-4xl dark:text-white">NURSING MANAGEMENT :</h2>
        <p className="my-4 text-lg text-gray-500">
        ...
        <h2 className="text-4xl dark:text-white">NURSING DIAGNOSIS :</h2>
        <p className="my-4 text-lg text-gray-500">
